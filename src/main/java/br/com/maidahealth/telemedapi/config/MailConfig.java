...
public class MailConfig implements ApplicationContextAware, EnvironmentAware {
    ...
    private static final String EMAIL_TEMPLATE_ENCODING = StandardCharsets.UTF_8.displayName();
    ...
    public TemplateEngine emailTemplateEngine() {
        ...
        // Resolver para emails TEXT (texto)
        templateEngine.addTemplateResolver(textTemplateResolver());
        // Resolver para emails HTML
        templateEngine.addTemplateResolver(htmlTemplateResolver());
        // Resolver para emails HTML editáveis (que são tratados como uma String)
    ...
    private ITemplateResolver stringTemplateResolver() {
        ...
        // Não possui um resolvable padrão, vai simplesmente processar como se fosse uma template String se os
        // resolvers anteriores não baterem
        templateResolver.setTemplateMode(TemplateMode.HTML);
        templateResolver.setCacheable(false);
        return templateResolver;
    }
