...
import {BillCardMobile} from './bill-card-mobile';
...
export default {
	 ...
	 */
	title: 'COMPONENTS/My Payments/BillCardMobile',
	component: BillCardMobile,
} as ComponentMeta<typeof BillCardMobile>;
...
export const Default: ComponentStory<typeof BillCardMobile> = () => <BillCardMobile {...args} />;
